          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
               ...
               <p><a href="total_departments.php">Total Departments</a></p>
              </div>
              <div class="icon">
           ...
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
               ...
               <p><a href="total_designations.php">Total Designations</a></p>
              </div>
              <div class="icon">
           ...
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                ...
                <p><a href="total_users.php">Total Users</a></p>
              </div>
              <div class="icon">
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                ...
                <p><a href="employee.php">Total Employees</a></p>
              </div>
              <div class="icon">
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                ...
                <p><a href="total_evaluators.php">Total Evaluators</a></p>
              </div>
              <div class="icon">
     ...
     <!--      <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                ...
                <p></p><p><a href="total_tasks.php">Total Tasks</a></p>
              </div>
              <div class="icon">
